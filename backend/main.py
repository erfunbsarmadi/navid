...
# placeholder for live mode. For prototype, return error instructing to upload CSV
raise HTTPException(status_code=404, detail="No live feed configured. Upload CSV to /upload_prices/{ticker}")
